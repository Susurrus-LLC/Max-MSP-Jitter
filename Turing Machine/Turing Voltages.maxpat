...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 378.0, 221.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 685.0, 492.0, 52.0, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 201.0, 351.0, 31.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 612.25, 492.0, 52.0, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 351.0, 31.0, 52.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 256.0, 151.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 66.5, 439.0, 137.0, 33.0 ],
					"text" : "resize bpatcher window to 270×416 for best fit",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 42.0, 287.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 6.0, 269.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 488.0, 492.0, 52.0, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.0, 351.0, 31.0, 52.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 403.0, 492.0, 52.0, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 351.0, 31.0, 52.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
