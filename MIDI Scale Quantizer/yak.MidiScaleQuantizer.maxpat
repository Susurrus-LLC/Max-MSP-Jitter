...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 131.0, 134.0, 257.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
,
					"text" : "coll yak.MidiScaleQuantizer.modes @embed 1"
				}
...
, 			{
		...
		"originid" : "pat-487",
		"dependency_cache" : [ 			{
				"name" : "yak.MidiScaleQuantizer.modes.txt",
				"bootpath" : "~/Music/Composing/Max MSP/Abstractions/yak/MIDI Scale Quantizer",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
